#!/usr/bin/env python3
"""
Base vs instruct: unified constrained-scoring runner.
...
Usage:
    python RQ3/base_instruct/run.py --model Qwen/Qwen2.5-7B --format plain \
...
# Official/ root (two levels up from RQ3/base_instruct/)
...
def run_established(model_name, surveys, fmt, tokenizer, out_dir, limit):
    for sname in surveys:
        ...
        survey = json.loads((OFFICIAL / cfg["file"]).read_text())
